      ...
      <div className="p-5 w-1/1  text-white flex text-center"
          style={{
            ...
            <div className="text-center flex flex-col justify-center items-start mr-[10rem]">
              <h1 className="text-[48px]  text-justify">Recover  account a<span className='text-yellow-400'>ccess</span></h1>
            </div>
      ...
      <div className="w-1/1 flex flex-col justify-center items-center p-5 bg-white">
              <div className="w-full max-w-md">
                <div>
                  ...
                  <p className="text-black mb-10 text-center">Enter your registered email adress to <br /> reset your password</p>
                </div>
                <form className="space-y-5">
                  <div className='relative'>
                    <span className='absolute left-4 top-4'><MdEmail /></span>
                    <input
                      type="email"
