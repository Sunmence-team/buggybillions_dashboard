...
const studentsData = [
  ...
  {
    id: 25005,
    name: "Temilade Adegbemro Olalere",
    stack: "Javascript",
    department: "Ui/Ux Deding",
    profile: FaUserCircle,
  },
  {
    id: 25006,
    name: "Jolaade Aderibigbe Olaonipekun",
    stack: "Html",
    department: "Full Stack",
    profile: FaUserCircle,
  },
  ...
  {
    id: 25008,
    name: "Gbolagade Adeoti Olasubomi",
    stack: "React",
    department: "Frontend",
    profile: FaUserCircle,
  },
  {
    id: 25009,
    name: "Tiwalade Adewunmi Oladele",
    stack: "Javascript",
    department: "Backend",
    profile: FaUserCircle,
  },
  {
    id: 25010,
    name: "Imade Adekunle Olaosebikan",
    stack: "Css",
    department: "FulL Stack",
    profile: FaUserCircle,
  },
...
const Student = () => {
  ...
  return (
    <>
      ...
      <div class="items-end justify-end mb-6 flex gap-4 w-full">
        <button
          onClick={() => setOpen(true)}
          class="bg-[#796FAB] text-white px-3 py-2 rounded-lg flex items-center gap-1 cursor-pointer"
        >
          Student Form
        </button>
        <button
                ...
                <tr>
                  ...
                  <td className="py-2 px-3">
                    <div className="flex gap-2">
                      <button
                        onClick={() => setSelectedStudent(alade)}
                        className="bg-white shadow p-2 rounded-md cursor-pointer"
                      >
                        <IoIosEye />
                      </button>
                    </div>
            ...
            <div className="fixed inset-0 bg-black/80 bg-opacity-40 flex justify-center items-center z-50">
              <div className="bg-white p-6 rounded-md w-100 relative">
                ...
                <div className="flex items-center justify-center">
                  <h2 className="text-xl font-semibold mt-6 rounded bg-gray-300 p-2">
                    <span> {<selectedStudent.profile size={30} />} </span>
                  </h2>
                </div>
          ...
          {selectedTutor && (
            <div className="fixed inset-0 bg-black/80 bg-opacity-40 flex justify-center items-center z-50">
              <div className="bg-white p-6 rounded-md w-96 relative curse-pointer">
                ...
                <div className="flex items-center justify-center">
                  <h2 className="font-semibold mt-6 rounded bg-gray-300 p-2">
                    <span> {<selectedTutor.profile size={30} />} </span>
                  </h2>
                </div>
                <div className="space-y-2 mt-2">
                  <p>
