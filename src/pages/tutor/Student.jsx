...
const studentsData = [
  {id: 25001, name: "Bamigbade Adeola Olabanji",stack:"Html", department:"Frontend"},
  {id: 25002, name: "Ajibade Adebisi Olakuleyin",stack:"Bootstrap", department:"Backend"},
  {id: 25003, name: "Tinuade Adekitan Olabamire", stack:"React", department:"Full Stack"},
  {id: 25004, name: "Sijuade Adegoke Olasiku", stack:"Css", department:"Frontend"},
  {id: 25005, name: "Temilade Adegbemro Olalere", stack:"Javascript", department:"Ui/Ux Deding"},
  {id: 25006, name: "Jolaade Aderibigbe Olaonipekun", stack:"Html", department:"Full Stack"},
  {id: 25007, name: "Omolade Adejare Oladayo", stack:"Html", department:"Ui/Ux Deding"},
  {id: 25008, name: "Gbolagade Adeoti Olasubomi", stack:"React", department:"Frontend"},
  {id: 25009, name: "Tiwalade Adewunmi Oladele", stack:"Javascript", department:"Backend"},
  {id: 25010, name: "Imade Adekunle Olaosebikan", stack:"Css", department:"FulL Stack"},
];
...
const Student = () => {
  ...
  return (
    <>
      ...
      <div>
            <div class="ml-[45rem] items-center mb-6">
      ...
      <div>
          <div className="w-full bg-white p-2 rounded-2xl shadow">
                       ...
                       <tr>
                         ...
                         <td className="py-2 px-3">
                            <div className="flex gap-2">
                                <button onClick={() => setOpen(true)}  className="bg-white shadow p-2 rounded-md cursor-pointer">
                                  <IoIosEye />  
                                </button>
                            </div>
                         </td>
      ...
      <div>
        <div className="w-full bg-white p-2 rounded-2xl shadow mt-15">
            ...
            <tbody>
              {tutor.map((dev,index) => (
                <tr>
                  ...
                  <td className="py-2 px-3">
                     <div className="flex gap-2">
                         <button className="bg-white shadow p-2 rounded-md cursor-pointer">
                           <IoIosEye />  
                         </button>
                     </div>
                  </td>
